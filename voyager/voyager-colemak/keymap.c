...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    MT(MOD_LSFT, KC_ESCAPE),KC_A,           MT(MOD_LCTL, KC_R),MT(MOD_LALT, KC_S),MT(MOD_LGUI, KC_T),KC_G,                                           KC_M,           MT(MOD_RGUI, KC_N),MT(MOD_LALT, KC_E),MT(MOD_RCTL, KC_I),KC_O,           TD(DANCE_0),    
    KC_TILD,        KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       TD(DANCE_1),    
                                                    LT(1, KC_SPACE),DUAL_FUNC_0,                                    LT(2, KC_TAB),  LT(3, KC_BSPC)
  ),
  [1] = LAYOUT_voyager(
